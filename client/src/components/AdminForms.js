...
export default function AdminForms(props) {
  ...
  const uploadImage = () => {
    ...
    formData.append('upload_preset', 'minor6');
    formData.append('cloud_name', 'minorpg6');
    fetch('https://api.cloudinary.com/v1_1/minorpg6/image/upload', {
      method: 'post',
      body: formData,
    })
      .then(res => res.json())
  ...
  const uploadImage2 = () => {
    ...
    formData.append('upload_preset', 'minor62');
    formData.append('cloud_name', 'minorpg6');
    fetch('https://api.cloudinary.com/v1_1/minorpg6/image/upload', {
      method: 'post',
      body: formData,
